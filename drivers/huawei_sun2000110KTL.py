...
class HuaweiSUN2000(BaseDriver):
    ...
    def register_map(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "info": [
                ...
                {"name": "type_code", "address": 30070, "length": 1, "type": "uint16", "scale": None},
                {"name": "rated_power", "address": 30073, "length": 2, "type": "uint32", "scale": 1},
    ...
    def read_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            rated_power_w = parsed.get("rated_power", 110000)
            capacity_kw = float(rated_power_w) / 1000.0 if rated_power_w is not None else 110.0
            ...
            return {
                ...
                "phase_count": 3,
                "string_count": 20,
                "rate_dc_kwp": capacity_kw,
                "rate_ac_kw": capacity_kw,
                "is_active": True,
